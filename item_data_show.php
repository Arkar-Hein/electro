...
function myFunction() {
  ...
  if (x.className === "topnav") {
    ...
    <div class="container">
        <div class="banner_rounded" style="color:black; font-size:30px; margin-top:3%; margin-left:30%;">Item Details</div>
          <div class="open-btn">
      ...
      <div class="form-popup" id="popupForm">
        <form method="POST" action="item_data.php" enctype="multipart/form-data"class="form-container" >
          <h2>Add Item</h2>
            <label for="psw">
          <strong>Item Name</strong>
          </label>
          <input type="text" id="psw" placeholder="Item Name" name="item_name" required>
          <label for="email">
          ...
          <input type="text" id="psw" placeholder="Item Made In" name="industry" required>
        ...
        if (event.target == modal) {
          closeForm();
			...
			<div class="center-me">
                ...
                <?php
                $conn=new mysqli("localhost","root","","electro");
                        $sql=$conn->query("select i.item_id,i.item_name,it.item_type_name,i.item_made_in from item_type it,item i
				...
				{		
					  $c1=$row['item_id'];
					  $c2=$row['item_name'];               $c3=$row['item_type_name'];
					  $c4=$row['item_made_in'];
                   ...
                   ";
					 echo"
					   <td>
					<a href=\"item_data_update.php? update_i_id=$c1
                    & update_i_name=$c2 & update_it_name=$c3 & update_ind=$c4\">
						<img src ='images/95-512.png' alt='price' width='30px' height='30px'>
					</a>
					  </td>
					  <td>
					  <a href=\"delete_i.php? delete_i_id=$c1 \">
