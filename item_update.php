	...
	<div class="container">
		<div class="banner rounded">
			<div class="center-me">
				...
				<form method="POST" action="item_update_data.php">
                    <div class="form-group">
						
						<input type="text" class="form-control" 
                             value="<?php echo $id;?>" hidden name="item_type_id" required/>
					</div>
					<div class="form-group">
						<label for="address">Item Type Name</label>
						<input type="text" class="form-control" 
                             value="<?php echo $name;?>" placeholder="Item Name" name="item_type_name" required/>
					</div>
	
					<button type="submit" name="submit" class="btn btn-primary btn-success" style="width:300px;">Submit</button>
				</form>
			</div>
		</div>
	</div>
